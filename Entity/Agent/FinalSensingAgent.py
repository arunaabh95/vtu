...
from Sensing.AdvancedInferenceAgent import AdvancedInferenceEngine
...
class FinalSensingAgent(Agent):
    ...
    def follow_path(self, explored_grid, path):
        ...
        for state in path:
            ...
            if self.complete_grid[state.x][state.y] == 1:
                # print("Inferred block ", state.x, "  ", state.y)
    ...
    def update_parent(self, parent_state, explored_grid):
        ...
        AdvancedInferenceEngine.infer(parent_state, sensed_state, explored_grid)
